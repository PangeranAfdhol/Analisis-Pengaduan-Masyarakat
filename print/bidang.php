...
?>
<title>Laporan Bidang Tahun <?php echo $_SESSION['tahun'];?></title>
<?php
...
<table width="100%" border="1" cellpadding="5" class="font">
  <thead>
	<tr>
	  <th height="37" colspan="2">NAMA PROGRAM / KEGIATAN</th>
	  <th>LOKASI</th>
	  <th>SUMBER DANA</th>
    </tr>
	<tr>
	  <th height="37" colspan="4" align="left">DAFTAR KEGIATAN PADA : <?php echo strtoupper($a['nmbidang']);?></th>
    </tr>
  </thead>
  <tbody>
  <?php
