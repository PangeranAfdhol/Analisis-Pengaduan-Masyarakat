...
* | Filename        : stemming.php
* | Instagram       : @susantokun
* | Blog            : http://www.susantokun.com
* | Info            : http://info.susantokun.com
* | Demo            : http://demo.susantokun.com
* | Youtube         : http://youtube.com/susantokun
* | File Created    : Sunday, 10th May 2020 4:42:23 pm
* | Last Modified   : Sunday, 10th May 2020 4:51:29 pm
* |==============================================================|
*/
...
function cekKamus($kata)
{
  ...
  include "config.php";
  $sql = $conn->query("SELECT * FROM m_katadasar WHERE katadasar = '" . $kata . "' LIMIT 1");
  $result = $sql->num_rows;
